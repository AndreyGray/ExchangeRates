...
public class DatePickerFragment extends DialogFragment {
    ...
    public static final String EXTRA_DATE = "PickedDate";
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        mDatePicker.setMaxDate(new Date().getTime());//-86400000);
    ...
    private void sendResult(int resultCode, String pickedDate) {
