# ExchangeRates
This is source code of ExchangeRates App, uses NBU(https://bank.gov.ua/NBUStatService/v1/) and Pb (https://api.privatbank.ua/#p24/exchangeArchive) APIs and use libraries : 
- Fragments 
